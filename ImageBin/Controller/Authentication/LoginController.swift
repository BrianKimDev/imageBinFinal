...
class LoginController: UIViewController {
    ...
    private let iconImageView: UIImageView = {
        let iv = UIImageView()
        iv.image = #imageLiteral(resourceName: "BIN ICON")
        iv.tintColor = .white
        return iv
    ...
    func checkFormStatus() {
        if viewModel.formIsValid {
            ...
            authButton.backgroundColor = #colorLiteral(red: 0.9098039269, green: 0.4784313738, blue: 0.6431372762, alpha: 0.6)
        }
    }
    ...
    func configureUI() {
        ...
        // already set custom dimensions
        iconImageView.anchor(top: view.safeAreaLayoutGuide.topAnchor, paddingTop: 33)
        ...
        registrationButton.anchor(left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, paddingLeft: 35, paddingRight: 35)
